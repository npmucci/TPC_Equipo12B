       ...
       <div class="card shadow-lg border-0 rounded-4 mx-auto" style="max-width: 500px;">
           <div class="card-body p-4">
               ...
               <div class="mb-3">
                   ...
                   <asp:RequiredFieldValidator ID="rfvPassActual" runat="server" ControlToValidate="txtPassActual" ErrorMessage="La contraseña actual es obligatoria." CssClass="text-danger" Display="Dynamic" ValidationGroup="PassGroup" EnableClientScript="false"/>
               </div>

               <div class="mb-3">
                   <label class="form-label fw-bold">Nueva Contraseña</label>
                   <asp:TextBox ID="txtPassNueva" runat="server" CssClass="form-control" TextMode="Password"></asp:TextBox>
                   <asp:RequiredFieldValidator ID="rfvPassNueva" runat="server" ControlToValidate="txtPassNueva" ErrorMessage="La nueva contraseña es obligatoria." CssClass="text-danger" Display="Dynamic" ValidationGroup="PassGroup" EnableClientScript="false"/>
               </div>

               <div class="mb-3">
                   <label class="form-label fw-bold">Confirmar Contraseña</label>
                   <asp:TextBox ID="txtPassConfirmar" runat="server" CssClass="form-control" TextMode="Password"></asp:TextBox>
                   <asp:RequiredFieldValidator ID="rfvPassConfirmar" runat="server" ControlToValidate="txtPassConfirmar" ErrorMessage="La confirmación es obligatoria." CssClass="text-danger" Display="Dynamic" ValidationGroup="PassGroup" />
                   <asp:CompareValidator ID="cvPassConfirmar" runat="server" ControlToValidate="txtPassConfirmar" ControlToCompare="txtPassNueva" ErrorMessage="Las contraseñas no coinciden." CssClass="text-danger" Display="Dynamic" ValidationGroup="PassGroup" EnableClientScript="false" />
               </div>
