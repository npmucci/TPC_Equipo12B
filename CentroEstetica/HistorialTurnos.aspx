                ...
                <div class="sticky-top" style="top: 90px; z-index: 1;">
                    ...
                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab-recepcionista" role="tablist" aria-orientation="vertical">
                        <button class="nav-link active" id="v-pills-historial-tab" data-bs-toggle="pill" data-bs-target="#v-pills-historial" type="button" role="tab" aria-controls="v-pills-historial" aria-selected="true">
                            <i class="bi bi-clock-history me-2"></i> Historial Turnos 
                        </button>
                    ...
                    <div class="tab-pane fade show active" id="v-pills-historial" role="tabpanel" aria-labelledby="v-pills-historial-tab" tabindex="0">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                ...
                                <h5 class="text-muted fw-normal">
                                    <asp:Label ID="lblNombre" runat="server" Text="[Nombre Recepcionista]"></asp:Label>
                                </h5>
                            </div>
                            <div class="text-end">
                        ...
                        <div class="card shadow-sm border-0 rounded-4 mb-4">
                            <div class="card-header fw-bold border-0 pt-3"
                                ...
                                <i class="bi bi-funnel me-1"></i> Opciones de Filtrado
                            </div>
                            ...
                            <div class="card-body p-4">
                                ...
                                <asp:UpdatePanel ID="upFiltrosAvanzados" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div>
                                        ...
                                        <div class="row g-3 border-top pt-3">
                                            <div class="col-md-3">
                                                ...
                                                <asp:DropDownList runat="server" AutoPostBack="true" CssClass="form-select form-select-sm"
                                                    ID="ddlEspecialidad" OnSelectedIndexChanged="ddlEspecialidad_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3">
                                                <asp:Label Text="Profesional" runat="server" CssClass="form-label small fw-bold" />
                                                <asp:DropDownList runat="server" AutoPostBack="true" CssClass="form-select form-select-sm"
                                                    ID="ddlProfesional" OnSelectedIndexChanged="ddlProfesional_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3">
                                                <asp:Label Text="Servicio" runat="server" CssClass="form-label small fw-bold" />
                                                <asp:DropDownList runat="server" CssClass="form-select form-select-sm" ID="ddlServicio">
                                                </asp:DropDownList>
                                            </div>
                                            <div class="col-md-3">
                                    ...
                                    <Triggers>
                                        ...
                                        <asp:AsyncPostBackTrigger ControlID="btnBuscarAvanzado" EventName="Click" />
                                    </Triggers>
                                </asp:UpdatePanel>
                            </div>
                        </div>
                                                ...
                                                <ItemTemplate>
                                                    <div class="btn-group btn-group-sm" role="group">
                                                        <asp:LinkButton ID="btnVerPagos" runat="server" CommandName="VerPagos" CommandArgument='<%# Eval("IDTurno") %>'
                                                            ToolTip="Ver Pagos del turno" CssClass="btn-custom btn-sm me-3">
                                                            Pagos
                                                        </asp:LinkButton>
                                                    </div>
                                                </ItemTemplate>
